...
/*
 * Wersja 2.0
 * W tej wersji przekazywane bêd¹ dwa dodakowe parametry :
 *	od³eg³oœæ od œrodka, która bêdzie wyznaczaæ gruboœæ aproksymacji (poprzednio by³a to gruboœæ wyra¿ona w ca³kowitych punktach)
 *	iloœæ punktów do wygenerowania na odcinku od œrodka do P1, który jest wyznaczony z odleg³oœci
 */

/* ------------------------------------------------------------------------------------------------------------------------------ */
void cISAR_GetProfile(C_Image_Container *p_image,	// INPUT: obraz wejciowy
					  double x0,					// INPUT: wspó³rzêdna x pierwszego punktu
					  double y0,					// INPUT: wspó³rzêdna y pierwszego punktu
					  double x1,					// INPUT: wspó³rzêdna x drugiego punktu
					  double y1,					// INPUT: wspó³rzêdna y drugiego punktu
					  unsigned int Nlen,			// INPUT: iloœæ punktów na odcinek P0P1
					  unsigned int Nszer,			// INPUT: po³owa gruboœci linii (jeœli 0 to jednal linia, 2 to trzy linie itd)
					  char method,					// INPUT: metoda: 0 - NN, 1 - spline
					  C_Matrix_Container *p_out,	// OUTPUT: macierz z profilem jasnoœci
					  C_Error* err);
/* ------------------------------------------------------------------------------------------------------------------------------ */
...
/*
	...
	[0] - obraz wejœciowy
	[1] - wspó³rzêdna x pierwszego punktu
	[2] - wspó³rzêdna y pierwszego punktu
	[3] - wspó³rzêdna x drugiego punktu
	[4] - wspó³rzêdna y drugiego punktu
	[5] - iloœæ punktów na odcinek P0P1
	[6] - po³owa szerokoœci odcinka
	[7] - metoda
*/
                 ...
                 const mxArray *prhs[])
{
	...
	cISAR_GetProfile(&image,	// obraz wejciowy
					 x0,		// wspó³rzêdna x pierwszego punktu
					 y0,		// wspó³rzêdna y pierwszego punktu
					 x1,		// wspó³rzêdna x drugiego punktu
					 y1,		// wspó³rzêdna y drugiego punktu
					 Nlen,		// iloœæ punktów na odcinek P0P1
					 Nszer,		// po³owa gruboœci linii (jeœli 0 to jednal linia, 2 to trzy linie itd)
					 method,	// metoda: 0 - NN, 1 - spline
					 &out,		// macierz z profilem jasnoœci
					 &err);
